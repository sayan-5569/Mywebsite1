...
class reportclass:
    def __init__(self,root):
        ...
        #===title===
        title = Label(self.root, text="View Result", font=("goudy old style", 20, "bold"), bg="#040c76", fg="#FFFFFF").place(x=10, y=15, width=1180, height=50)
        ...
        btn_search=Button(self.root,text='Search',font=("goudy old style",15,"bold"),bg="#008cff",fg="white",cursor="hand2",command=self.search).place(x=680,y=100,width=100,height=35)
